...
- `ADMIN_USER_IDS`
- optional: `SLACK_VERIFICATION_TOKEN`, `SLACK_AUTH_TOKEN_FALLBACK` (default `true`), `DEFAULT_LESSON_CHANNEL`, `DEFAULT_ONBOARDING_CHANNEL`, `ONBOARDING_SHEET_NAME`, `BATCH_LIMIT`, `DRY_RUN`, `QUEUE_MAX_RETRIES`, `AI_DISABLED`
